//Edit : Error message if there are missing permissions
...
module.exports.run = async (bot, message, args) => {
    ...
    if (!message.member.hasPermission("MANAGE_MESSAGES")) return message.channel.send("You are not allowed to use these command! Permission required : `MANAGE_MESSAGE`");;
